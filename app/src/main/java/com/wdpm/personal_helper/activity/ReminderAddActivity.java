...
public class ReminderAddActivity extends AppCompatActivity implements
    ...
    public void saveReminder(){
        ...
        mTimestamp=formatter.format(curDate);
        Log.i("mTimestamp---->",mTimestamp);

        // Creating Reminder
        int ID = rb.addReminder(new Reminder(mTitle, mDate, mTime, mRepeat, mRepeatNo, mRepeatType, mActive, mTimestamp));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.discard_reminder:
                Toast.makeText(getApplicationContext(), "Add Discarded",
                        Toast.LENGTH_SHORT).show();
