...
package com.wdpm.personal_helper.db;
...
public class ReminderDatabase extends SQLiteOpenHelper {
    ...
    private static final String KEY_REPEAT = "is_repeat";
    ...
    public List<Reminder> getAllReminders(){
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                reminder.setTimestamp(cursor.getString(8));
    ...
    //judge a reminder exists
    public boolean isReminderAlreadyExists(int id){
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.query(TABLE_REMINDERS, new String[]
                        {
                                KEY_ID,
...
//        String sql="select * from"+TABLE_REMINDERS+"where id=?";
